...
layout(location = 2) out float outputMaterialBaseIndex;
...
layout(location = 2) in flat float inputMaterialBaseIndex;
...
void main() {
    outputColor = texture(materials[int(inputMaterialBaseIndex)], inputUV) * inputColor;
}
